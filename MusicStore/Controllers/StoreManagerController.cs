...
namespace MusicStore.Controllers
{
    public class StoreManagerController : Controller
    {
        ...
        public ActionResult Edit([Bind(Include = "AlbumId,GenreId,ArtistId,Title,Price,AlbumArtUrl")] Album album)
        {
            ...
            //{
            //    string[] fieldsToBind = new string[] { "GenreId", "ArtistId", "Title", "Price", "AlbumArtURL", "RowVersion" };
            //    if (TryUpdateModel(album,fieldsToBind))
            //    {
            //        try
            //        {
            ...
            //                if (databaseValues.AlbumArtUrl != clientValues.AlbumArtUrl)
            //                    ModelState.AddModelError("AlbumArtUrl", "Current value: "
            //                        + databaseValues.AlbumArtUrl);
